...
<div class="bg-indigo-50 min-h-screen md:px-20 pt-5">
    <div class=" bg-white rounded-md px-6 py-10 max-w-2xl mx-auto">
      <h1 class="text-center text-2xl font-bold text-gray-500 mb-6"> --- TAMBAH PEMESANAN ---</h1>
      <div class="space-y-5">
    <div class="container">
    <form action="proses_tambah_pemesanan.php" method="post">
        ...
        <br>
        <table class="table text-black" style="background-color:  #4863A0;">
            <tr>
                <th>JENIS</th>
                <th>HARGA</th>
                <th>QTY</th>
