...
<div class="min-h-screen flex">
  ...
  <div class="bg-indigo-50 flex-grow py-12 px-10">
    ...
    <div class=" bg-white rounded-md px-6 py-10 max-w-2xl mx-auto">
      <h1 class="text-center text-2xl font-bold text-gray-500 mb-6"> --- TAMBAH PAKET LAUNDRY ---</h1>
      <div class="space-y-5">
    <div class="container">
    <form action="proses_tambah_paket.php" method="post">
        <br>
        Jenis Laundry :
        <input type="text" name="jenis" value="" class="form-control" placeholder="Masukkan Jenis Paket Laundry" required>
        <br>
        Harga :
        <input type="number" name="harga" value="" class="form-control" placeholder="Masukkan Harga" required>
        <br>
        Proses Pengerjaan : 
        <input type="text" name="proses" value="" class="form-control" placeholder="" required>
        <br>
        <input type="submit" name="simpan" value="Tambah Paket" class="w-100 btn btn-lg text-white" style="background-color: #008000;">
    </form>
    </div>
    </div>
    </div>
