...
<body>
    ...
    <form action="proses_ubah_transaksi.php" method="post">
        ...
        <select name="id_member" class="form-control"> 
            ...
            <?php
            include "koneksi.php";
            $qry_pelanggan=mysqli_query($koneksi, "select * from member");
        ...
        Status :
        <?php 
        $arr_status=array('Baru'=>'Baru', 'Sedang Diproses'=>'Sedang Diproses', 'Selesai'=>'Selesai', 'Diambil'=>'Diambil');
        ?>
        ...
        Dibayar :
        <?php 
        $arr_dibayar=array('Dibayar'=>'Dibayar', 'Belum Dibayar'=>'Belum Dibayar');
        ?>
        ...
        <select name="id_user" class="form-control"> 
            ...
            while ($data_user=mysqli_fetch_array($qry_user)){
                ...
                echo '<option value="'.$data_user['id_user'].'" '.$select.'>'.$data_user['nama_user'].'</option>';  
            }
            ?>
        </select><br>
        
        <input type="submit" name="simpan" value="Update Transaksi" class="w-100 btn btn-lg text-white" style="background-color: #92A9BD;">
        </br>
    </form>
