...
<div class="min-h-screen flex">
  ...
  <div class="bg-indigo-50 flex-grow py-12 px-10">
    ...
    <!-- Component -->
    <div class="bg-indigo-50 min-h-screen md:px-20 pt-15">
    <div class=" bg-white rounded-md px-6 py-10 max-w-2xl mx-auto">
      <h1 class="text-center text-2xl font-bold text-gray-500 mb-6"> --- TAMBAH PELANGGAN ---</h1>
      <div class="space-y-5">
    <div class="container">
    <form action="proses_tambah_pelanggan.php" method="post">
        ...
        <br>
        Telp : 
        <input type="number" name="tlp" value="" class="form-control" placeholder="Masukkan No. Hp" required>
        <br>
        <input type="submit" name="simpan" value="Tambah Pelanggan" class="w-100 btn btn-lg text-white" style="background-color: #008000;">
    </form>
    </div>
    </div>
    </div>
