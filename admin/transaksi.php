  ...
  <div class="bg-indigo-50 flex-grow py-12 px-10">
    <div class="flex justify-between">
      <div>
        ...
        <h1 class="text-4xl font-bold text-indigo-900 mt-">--- DATA TRANSAKSI ---</h1>
      </div>
      <div>
    ...
    <thead class="justify-between">
              <tr class="text-center bg-indigo-600">
                <th class="px-10 py-2">
                  <span class="text-indigo-50">TGL. MASUK</span>
                </th>
                <th class="px-10 py-2">
                ...
                <th class="px-10 py-2">
                  <span class="text-indigo-50">LAUNDRY</span>
                </th>
                <th class="px-10 py-2">
                  <span class="text-indigo-50">TOTAL</span>
                </th>
                <th class="px-10 py-2">
                  <span class="text-indigo-50">STATUS LAUNDRY</span>
                </th>
                <th class="px-10 py-2">
                  <span class="text-indigo-50">STATUS PEMBAYARAN</span>
                </th>
                <!-- <th class="px-10 py-2">
  ...
  <?php
           ...
           while($data_transaksi=mysqli_fetch_array($qry_transaksi)){
            ...
            ?>    
                ...
                <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b block lg:table-cell relative lg:static"><?php echo $data_transaksi['tgl'];?></td>
                <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b block lg:table-cell relative lg:static"><?php echo $data_transaksi['id_transaksi'];?></td>
                <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b block lg:table-cell relative lg:static"><?php echo $data_transaksi['nama'];?></td>
                <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b block lg:table-cell relative lg:static"><?php echo $detail?></td>
                <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b block lg:table-cell relative lg:static">Rp <?php echo $data_transaksi['total'];?>,00.</td>  
                    ...
                    <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b block lg:table-cell relative lg:static">
                        ...
                        <a type="submit" value="Bayar" name="status" class="btn text-white" style="background-color: #0041C2;" href="ubah_bayar.php?id_member=<?php echo $data_transaksi['id_member']?>">
                            Bayar
                        </a>
                        </form>                   
                    </td> 
