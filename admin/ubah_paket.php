...
<div class="min-h-screen flex">
  ...
  <div class="bg-indigo-50 flex-grow py-12 px-10">
    ...
    <div class=" bg-white rounded-md px-6 py-10 max-w-2xl mx-auto">
      <h1 class="text-center text-2xl font-bold text-gray-500 mb-6"> --- EDIT PAKET ---</h1>
      <div class="space-y-5">
    <div class="container">
    <form action="proses_edit_paket.php" method="post">
        <input type = "hidden" name="id_paket" value ="<?=$data_paket['id_paket']?>">
        Jenis Laundry :
        <br><input type ="text" name ="jenis" value ="<?=$data_paket['jenis']?>" class = "form-control"></br>
        Harga :
        <br><input type ="number" name ="harga" value ="<?=$data_paket['harga']?>" class = "form-control"></br>
        Proses Pengerjaan : 
        <br><input type="text" name="proses" value="<?=$data_paket['proses']?>" class="form-control"></br>
        <input type="submit" name="simpan" value="Update Paket" class="w-100 btn btn-lg text-white" style="background-color: #008000;">
        </br>
    </form>
    </div>
    </div>
